    ...
    >
      <div className="mx-auto max-w-7xl">
            ...
            <AnimatedSection key={item.step} delay={index * 0.08}>
              <article className="h-full rounded-[34px] border border-black/10 bg-white p-6 shadow-[0_24px_90px_rgba(0,0,0,0.06)]">
                <div className="flex items-center gap-4">
                  <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[#2563eb] text-sm font-bold text-white">
                    {item.step}
                  </span>
        ...
        <AnimatedSection delay={0.22}>
          <div className="mt-6 rounded-[30px] border border-[#2563eb]/20 bg-[#2563eb]/10 px-6 py-5">
