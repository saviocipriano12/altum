...
export default function ClientePainelError({ error, retry }: { error: Error & { digest?: string }; retry: () => void }) {
  ...
  return (
    <PanelCard className="mx-auto max-w-2xl p-6 text-center sm:p-10" tone="danger">
      <span className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-[var(--cliente-danger-soft)] text-[var(--cliente-danger)]">
      ...
      <ClientActionButton tone="primary" className="mt-7 min-h-11" onClick={retry}>
