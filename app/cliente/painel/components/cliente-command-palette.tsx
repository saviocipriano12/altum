...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: "conversas", label: "Conversas", href: "/cliente/painel/inbox", icon: <MessageSquare className="h-4 w-4" />, module: "inbox" },
  { key: "clientes", label: "Clientes & Oportunidades", href: "/cliente/painel/crm", icon: <Target className="h-4 w-4" />, module: "crm" },
  { key: "funil", label: "Clientes & Oportunidades - funil", href: "/cliente/painel/pipeline", icon: <Target className="h-4 w-4" />, module: "crm" },
  {
    key: "comercial",
  ...
  { key: "agenda", label: "Agenda", href: "/cliente/painel/agenda", icon: <CalendarDays className="h-4 w-4" />, module: "crm" },
  { key: "retornos", label: "Agenda - retornos", href: "/cliente/painel/follow-ups", icon: <CalendarDays className="h-4 w-4" />, module: "crm" },
  ...
  { key: "assistente", label: "Assistente Altum", href: "/cliente/painel/ia", icon: <Bot className="h-4 w-4" />, capability: "manage_ai", module: "ai" },
  {
    key: "conhecimento",
