    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div className="space-y-2">
          ...
          {createdAtFormatted && (
            <p className="text-[11px] text-slate-400">Criado em {createdAtFormatted}</p>
          )}
        </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4">
        <p className="text-[11px] uppercase tracking-wide text-slate-500">Atualizar status</p>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 space-y-3">
            ...
            {editing ? (
              <div className="grid gap-2 md:grid-cols-2">
                ...
                <div className="space-y-1">
                  <p className="text-[11px] text-slate-500">Validade</p>
                  <div className="flex items-center gap-2 rounded-lg bg-slate-50 px-3 py-2 border border-slate-200">
                ...
                <div className="space-y-1 md:col-span-2">
                  <p className="text-[11px] text-slate-500">Resumo</p>
                  <input
                    className="w-full rounded-lg bg-slate-50 px-3 py-2 text-xs outline-none border border-slate-200"
              ...
              <div className="space-y-2 text-xs text-slate-700">
                ...
                {orc.resumo && (
                  <p className="text-[11px] text-slate-500 mt-1">
                    <span className="text-slate-500">Resumo:</span> {orc.resumo}
                  </p>
                )}
              </div>
            )}
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-slate-200 bg-white p-4 space-y-2">
            ...
            <p className="text-sm text-slate-900">{orc.clientName}</p>

            {orc.projectTitle ? (
              <p className="text-xs text-slate-500">
                Vinculado ao projeto: <span className="text-slate-900">{orc.projectTitle}</span>
              </p>
            ) : (
              <p className="text-xs text-slate-500">
            ...
            <div className="pt-2 flex flex-col gap-2 text-xs">
              ...
              {orc.projectId && (
                <Link
                  href={`/admin/projetos/${orc.projectId}`}
                  className="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-slate-900 hover:bg-slate-50 transition"
                >
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 space-y-2">
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-900 hover:bg-slate-50 transition"
            >
          ...
          <div className="rounded-xl border border-emerald-500/30 bg-white    p-4 space-y-2">
            <div className="flex items-center justify-between">
