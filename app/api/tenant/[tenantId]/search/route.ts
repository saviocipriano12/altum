...
const MODULES = [
  ...
  { id: "agenda", label: "Agenda", path: "/cliente/painel/agenda", description: "Compromissos e reunioes" },
  ...
  { id: "ia", label: "Assistente Altum", path: "/cliente/painel/ia", description: "Como a IA responde, aprende e chama uma pessoa" },
  ...
  { id: "go_live", label: "Implantacao", path: "/cliente/painel/go-live", description: "Prontidao e checklist da conta" },
