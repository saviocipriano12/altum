...
const links = {
  consult: "/diagnostico?entry=portfolio_advogado3_consult",
  analysis: "/diagnostico?entry=portfolio_advogado3_analysis",
  contact: "/diagnostico?entry=portfolio_advogado3_contact",
};
